    ...
    <div className="flex gap-10 p-4 flex-wrap  h-full items-center w-full justify-center">
      ...
      <div className="xl:w-1/2 2xl:w-1/2 lg:w-full md:w-full sm:w-full  h-max">
        ...
        <span>
          ...
          <button onClick={()=>dispatch(addItem({id,...Product}))} className="px-20 text-white bg-black py-1 my-10 transition-all hover:bg-white border-2 hover:border-2 hover:border-black hover:text-black">
            Add to Cart
          </button>
        </span>
      </div>
